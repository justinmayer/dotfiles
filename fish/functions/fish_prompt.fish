function fish_prompt --description "Write out the prompt"
    ...
    if test -z $__vcsystem
        ...
        switch $__vcsystem
            ...
            set hg_promptstring "$__fish_prompt_gray on $__fish_prompt_repo_branch_color<branch>$__fish_prompt_repo_status_color<status|modified|unknown><update>$__fish_prompt_normal"
